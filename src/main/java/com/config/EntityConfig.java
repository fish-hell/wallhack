...
public class EntityConfig {
    ...
    public boolean isEntityVisible(ResourceLocation entityId) {
        return entityVisibility.getOrDefault(entityId, false);
    }

    public boolean isEntityVisible(EntityType<?> entityType) {
        return isEntityVisible(EntityType.getKey(entityType));
    }

    public void setEntityVisible(ResourceLocation entityId, boolean visible) {
        entityVisibility.put(entityId, visible);
    }

    public void toggleEntity(ResourceLocation entityId) {
        entityVisibility.put(entityId, !isEntityVisible(entityId));
    }

    public int getEntityColor(ResourceLocation entityId) {
        return entityColors.getOrDefault(entityId, 0xFFFFFF);
    }

    public int getEntityColor(EntityType<?> entityType) {
        return getEntityColor(EntityType.getKey(entityType));
    }

    public Map<ResourceLocation, Boolean> getAllEntities() {
        return entityVisibility;
    }

    public Map<String, List<ResourceLocation>> getCategories() {
        return categories;
    }
    ...
    public String getEntityDisplayName(ResourceLocation entityId) {
