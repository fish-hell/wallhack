...
import net.fabricmc.fabric.api.client.rendering.v1.LevelRenderer;
...
public class WallHackMod implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        LOGGER.info("WallHack Mod initialized");
        KeyHandler.register();
        ClientTickEvents.END_CLIENT_TICK.register(KeyHandler::onClientTick);
        LevelRenderer.AFTER_TRANSLUCENT.register(RenderHandler::onRenderLevel);
    }
